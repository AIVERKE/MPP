    ...
    const schemas = ref({
        ...
        procedimiento: {
            ...
            fields: [
                ...
                { key: "estado_version", label: "Estado de Versión", type: "select", options: ["Borrador", "En Revisión", "Aprobado", "Obsoleto"], default: "Borrador" },
                { key: "estado", label: "Estado General", type: "select", options: ["Activo", "Inactivo"], default: "Activo" },
